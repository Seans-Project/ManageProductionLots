		...
		onTheMasterPage : {
			...
			actions : {
				...
				iSortTheListOnUnitNumber : function () {
					return this.iChooseASorter("sortButton", "Sort By <WeightTotal>");
				},

				iFilterTheListOnUnitNumber : function () {
					return this.iMakeASelection("filterButton", "<WeightTotal>", "<100 <WeightTotal>");
				},

				iGroupTheList : function () {
					return this.iChooseASorter("groupButton", "<WeightTotal> Group");
				},
			...
			assertions : {
				...
				theListShouldBeFilteredOnUnitNumber : function () {
					return this.theListShouldBeFilteredOnFieldUsingComparator("WeightTotal", 100);
				},


				theListShouldBeSortedAscendingOnUnitNumber : function () {
					return this.theListShouldBeSortedAscendingOnField("WeightTotal");
				},
