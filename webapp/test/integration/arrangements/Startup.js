sap.ui.define([
	"sap/ui/test/Opa5",
	"erp/com/ManageProductionLots/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("erp.com.ManageProductionLots.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "erp.com.ManageProductionLots",
					async: true
				},
				hash: oOptions.hash,
